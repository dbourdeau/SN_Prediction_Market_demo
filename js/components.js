    ...
    steps: [
        {
            ...
            text: 'You start with 1,000 SharkBucks — virtual currency used to trade. Buy YES or NO shares on questions you believe in. Winning positions pay out when markets resolve.',
            icon: '💰',
        },
        {
            target: () => document.getElementById('nav-markets'),
            title: 'Browse Markets',
            text: 'Markets are questions about the future — product launches, revenue targets, competitor moves, and more. Browse open markets, filter by department or category, and find questions where your expertise gives you an edge.',
            icon: '📊',
        },
        {
            target: () => document.querySelector('.cursor-pointer.rounded-xl'),
            title: 'Place a Trade',
            text: 'Each market card shows the current probability and recent activity. Click any market to see the full price chart, discussion, and trade panel. Buy YES if you think it\'ll happen, NO if you don\'t — the market price shifts with every trade.',
            icon: '🎯',
        },
        {
            target: () => document.getElementById('nav-create'),
            title: 'Create a Market',
            text: 'Have a question worth forecasting on? Propose your own market. Use the AI Suggest feature to generate well-formed questions based on a topic — the AI checks that your question is clear, binary, and resolvable. Markets go live after admin approval.',
            icon: '✨',
        },
        {
            target: () => document.getElementById('nav-tournaments'),
            title: 'Tournaments',
            text: 'Tournaments group related markets into themed forecasting competitions — a product launch sprint, a quarterly earnings challenge, or a strategy scenario. Each tournament has its own leaderboard and prize pool. Check the active ones and compete!',
            icon: '🏆',
        },
        {
            target: () => document.getElementById('chat-toggle-btn'),
            title: 'AI Assistant & Intel Briefing',
            text: 'Two AI-powered features: the 💬 chat button (bottom-right) answers questions about how SharkPool works, explains market mechanics, and helps you get started. Intel Briefing (in the More menu) generates AI analysis of any open market — summarizing sentiment, key arguments, and probability drivers.',
            icon: '🤖',
        },
        {
            target: () => document.getElementById('nav-leaderboard'),
            title: 'Awards & Prizes',
            text: 'Top forecasters win real money each quarter — over $1,500 in prizes including $400 for Top Forecaster, $300 for Sharpest Mind, and a $200 raffle just for participating. Winners are announced at the All-Hands. Check the Awards tab to see current standings.',
            icon: '🎖️',
        },
        {
            target: () => document.getElementById('nav-notifications'),
            title: 'Stay in the Loop',
            text: "You'll be notified when markets you're watching move significantly, when your predictions resolve (win or lose), and when new markets launch. That's it — you're ready to start forecasting!",
            icon: '🔔',
        },
    ],
