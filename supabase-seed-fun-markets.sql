...
BEGIN
    ...
    (
        ...
        admin_id, 'System Seed', '2026-04-01', false, admin_id, NOW(), '[0.50]'::jsonb
    ),
    (
        ...
        'fun', 'binary', 0.50, 0, 0, 0, 0, 0, 'active',
        admin_id, 'System Seed', '2026-03-31', false, admin_id, NOW(), '[0.50]'::jsonb
    ),
    (
        ...
        'fun', 'binary', 0.50, 0, 0, 0, 0, 0, 'active',
        admin_id, 'System Seed', '2026-06-30', true, admin_id, NOW(), '[0.50]'::jsonb
    ),
    (
        ...
        'fun', 'binary', 0.50, 0, 0, 0, 0, 0, 'active',
        admin_id, 'System Seed', '2026-07-01', false, admin_id, NOW(), '[0.50]'::jsonb
    ),
    (
